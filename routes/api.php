...
Route::middleware(['super.admin','auth:api'])->group(function (){
    ...
    //====================== Super Admin Teacher ============================
    Route::resource('teachers',RTeacherController::class)->except('create','edit','update','index');
...
Route::get('/admit-student/v2',[AdmitController::class,'showAdmitStudentV2']);
...
Route::post('/course-enroll-authorization',[AddEmployeeController::class,'courseEnrollAuthorization'])->middleware('s.student');
